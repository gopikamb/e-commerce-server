...
router.get('/wishlist/get-all-items',wishlistController.getAllWishlistsItems)
...
//route for incremanting cart item quantity
router.get('/cart/increment-item/:id',cartController.incrCartItem)
//route for decremanting cart item quantity

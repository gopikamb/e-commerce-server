    ...
    try{
        ...
        if(product){
           ...
           const newProduct = new cartitems({
            id,title,price,image,quantity,grantTotal:price //initially value of grantTotal is price
           })
           //to save changes in mongodb
